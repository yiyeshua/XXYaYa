...
public class DateUtil {
     ...
     * @return 
     */  
    public static Date getCounterglow(Date date, int countMonth) {
        Calendar ca = Calendar.getInstance();  
        ca.setTime(date);  
        ca.add(Calendar.MONTH, countMonth);
        return ca.getTime();  
    }  
    ...
    public static void main(String[] args) throws Exception{
		System.out.println(getSeconds("2015-09-10 12:30:00","2015-09-10 13:30:00"));
		System.out.println(getSecondsInterval(addSecond(new Date(), 2)));
		System.out.println(fmtDateToYMD(getFirstDayOfWeek(new Date(),-1)));
		System.out.println(fmtDateToYMD(getLastDayOfWeek(new Date(),-1)));
		System.out.println(fmtStrToDate("2016-01-11 12:15:23", "yyyy-MM-dd HH:mm:ss"));
	}
}
