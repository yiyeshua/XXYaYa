...
import com.yiyeshu.xxyaya.views.CommonDialogFragment;
...
public class PermissionUtil {
    ...
    public static void showPermissionDetail(FragmentActivity activity, int tipResID, boolean isToFinishActivityOnCancel) {
        showPermissionDetail(activity, AppUtils.getAppContext().getString(tipResID), isToFinishActivityOnCancel);
    }
